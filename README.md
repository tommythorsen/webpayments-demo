...
3. Drag the extension file (mediator-extension.nex) you downloaded earlier from a file browser window and drop it onto the extensions pane.

Your extension pane should now look something like this: ![Screenshot of extensions pane](images/mediator-extension.png)
